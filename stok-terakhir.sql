...
insert into m_history_barang (tanggal, kode_barang, stok_akhir) values ('02/01/09', 'A', 5);
insert into m_history_barang (tanggal, kode_barang, stok_akhir) values ('02/01/09', 'B', 1);
insert into m_history_barang (tanggal, kode_barang, stok_akhir) values ('03/01/09', 'A', 3);
insert into m_history_barang (tanggal, kode_barang, stok_akhir) values ('03/01/09', 'B', 3);
